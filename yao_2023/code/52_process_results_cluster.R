...
summary_file <- file.path(work_directory, 
                     'yao_2023/data/intermediate_data/', batch_name, '/all_results_summary.csv')

clustering_file <- file.path(work_directory, 
                        "yao_2023/data/module_list_df_2000_genes.csv")
...
fwrite(processed_results_dt, 
       file.path(work_directory, 'yao_2023/data/intermediate_data/', batch_name, '/processed_results.csv'))
